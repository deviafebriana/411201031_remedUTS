...
@section('konten')
 ...
 <form action='{{ url('lokasi/'.$data->id) }}' method='post'>
    @csrf 
    @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='kode_lokasi' value="{{ $data->kode_lokasi }}" id="kode_lokasi">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama_lokasi" class="col-sm-2 col-form-label">Nama Lokasi</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama_lokasi' value="{{ $data->nama_lokasi }}" id="nama_lokasi">
                </div>
            </div>
            <div class="mb-3 row">
