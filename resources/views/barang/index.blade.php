@extends('layout.template')
        ...
        @section('konten')
         <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <a href='{{ url('lokasi') }}' class="btn btn-secondary">Input Lokasi</a>
            <a href='{{ url('pengiriman') }}' class="btn btn-secondary">Input Pengiriman</a>
                <!-- FORM PENCARIAN -->
                <div class="pb-3">
                        ...
                        @foreach ($data as $item)
                          <tr>
                            ...
                            <td>
                                ...
                                <form onsubmit="return confirm('Yakin ingin hapus data?')" class='d-inline' action="{{ url('barang/'.$item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
