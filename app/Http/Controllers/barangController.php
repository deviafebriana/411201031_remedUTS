...
class barangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('barang')->with('success','Data sudah diinput');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->to('barang')->with('success','Data sudah di update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to('barang')->with('success','Berhasil delete data');
    }
}
